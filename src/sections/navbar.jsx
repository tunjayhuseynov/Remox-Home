        ...
        <div className="flex justify-between items-center h-full">
            ...
            <div className="flex gap-5">
                <div className="self-center border-1 rounded-sm border-primary">
                    <div className="relative">
                        <div onClick={() => setOpen(!isOpen)} className="font-normal text-white px-2 sm:px-2 py-[5px] rounded-lg cursor-pointer bg-sec border border-primary  flex space-x-1 items-center justify-center ">
                            <span className="flex items-center justify-center"><img src={`/${value ? value : 'celo'}.png`} alt="" className="w-[15px] h-[15px] mr-1" />{value ? value : 'celo'}</span>
                            <div>
                ...
                <div className="self-center hidden sm:block">
                    <a href={`https://app.remox.io/${value}`} className="bg-primary px-8 py-2 font-semibold rounded-md text-white hover:bg-transparent hover:text-primary transition-all duration-400" target="_blank">Enter App</a>
                </div>
            </div>
        </div>
    </div>
